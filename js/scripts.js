$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Michael and Aga's Wedding",

            // Event start date
            start: new Date('Jun 27, 2026 12:30'),
            ...
            end: new Date('Jun 27, 2026 23:59'),

            // Event Address
            address: 'Harburn Barn, West Calder',

            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues, please contact the bride and groom."
        }
    });
...
// Google map
function initMap() {
    var location = {lat: 55.833328, lng: -3.519767};
